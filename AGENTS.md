...
Este proyecto se generó con el perfil **`completo`**. El conjunto de
...
|--------|---------|-------------|
| `minimo` | 28 | Núcleo de calidad (harness, git, test, review, data, ml...) |
...
- **Conoce este template.** Los agentes saben que el código vive en
  `inversion/`, los datasets en `data/`, los modelos en `models/`.
...
El catálogo — los 27 agentes con su responsabilidad, los workflows por
