...
class GStack:
    ...
    def __init__(self, auto_commit: bool = False, commit_on_error: bool = True, log_events: bool = True, context=None, confirm: bool = False, lock: bool = True):
            ...
            self._log_evento_suelto(
                {
                    ...
                    "message": "auto-commit omitido: la stack no está autorizada (GStack(confirm=True) o DSKIT_ASSUME_YES=1)",
                }
            )
            return
        try:
