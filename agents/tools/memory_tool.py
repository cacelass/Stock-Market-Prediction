...
class MemoryTool:
    ...
    @staticmethod
    def write(workspace_dir: str | Path, kind: str, key: str, value: Any, *, ttl: int | None = None, scope: str = DEFAULT_SCOPE) -> dict:
    ...
    @staticmethod
    def edit(workspace_dir: str | Path, key: str, *, value: Any = None, scope: str | None = None, ttl: int | None = None) -> dict | None:
    ...
    @staticmethod
    def search(workspace_dir: str | Path, *, kind: str | None = None, query: str | None = None, scope: str | None = None, limit: int = 20) -> list[dict]:
        bank = _load_bank(workspace_dir)
        results = []
