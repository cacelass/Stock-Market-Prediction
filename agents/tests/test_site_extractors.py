...
def test_github_raw_url_readme_por_defecto():
    assert github_raw_url("https://github.com/cacelass/dskit") == ("https://raw.githubusercontent.com/cacelass/dskit/HEAD/README.md")


def test_github_raw_url_resuelve_blob():
    assert github_raw_url("https://github.com/o/r/blob/main/src/foo.py") == ("https://raw.githubusercontent.com/o/r/HEAD/src/foo.py")
...
def test_github_extrae_readme(monkeypatch):
    ...
    monkeypatch.setattr("agents.tools.site_extractors.RestTool.get", lambda *a, **kw: _Resp())
