...
class MemoryAgent(BaseAgent):
    ...
    def memory_edit(self, *, id: str, action: str = "update", value: str | None = None, scope: str | None = None, ttl: int | None = None) -> AgentResult:
        """
        ...
        if action == "forget":
            ...
            return AgentResult(True, self.name, "memory_edit", f"Memoria '{id}' olvidada.", data={"id": id, "action": action})
        ...
        if edited is None:
            return AgentResult(True, self.name, "memory_edit", f"Memoria '{id}' invalidada.", data={"id": id, "action": action})
        return AgentResult(
            True,
            self.name,
            "memory_edit",
    ...
    def status(self) -> AgentResult:
        ...
        return AgentResult(
            ...
            data={
                ...
                "total": total,
                "entries_by_scope": scopes,
                "bank_size_bytes": size,
            },
        )
